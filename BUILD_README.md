#Nucleus Token Server

Building nucleus-token-server
==============
...
> java -classpath ./build/libs/nucleus-token-server-0.1-snapshot-fat.jar: -Dvertx.logger-delegate-factory-class-name=io.vertx.core.logging.SLF4JLogDelegateFactory io.vertx.core.Launcher -conf src/main/resources/nucleus-token-server.json -cluster -instances 4
